...
public class JSCP {
    ...
    public static int main(String arg) {
        ...
        try {
            ...
            Supplier<Runnable[]> fixPrecedences = conflictOrderingSearch(minDomVariableSelector(precedencesArray), x -> x.min());
            DFSearch dfs = makeDfs(cp, and(fixPrecedences, fixMakespan));
